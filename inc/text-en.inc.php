...
$text['add_to'] = 'Add to';
$text['error-sql-incorrect'] = 'An error occured in a database query.';
$text['add'] = 'Add';
...
$text['Minimum width was not reached.'] = 'Minimum width was not reached.';
$text['Minimum height was not reached.'] = 'Minimum height was not reached.';
