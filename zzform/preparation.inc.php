 ...
 * @return array $fields
 */
function zz_prepare_fields_from_fielddefs(&$fielddefs, $fields, $rec) {
 ...
 * @return array $my_tab
 */
function zz_prepare_subrecord_values($my_tab, $rec) {
	...
	if (!empty($my_tab['fielddefs'])) {
		$my_tab[$rec]['fields'] = zz_prepare_fields_from_fielddefs(
